...
public class Java8Tester {
    ...
    public static void main(String[] args) {
        ...
        List<String> filterd = deleteEmptyStringUsingJava7(strings);
        System.out.println("筛选后的列表：" + filterd);
        ...
        List<Integer> squaresList = getSqures(numbers);
        ...
        System.out.println("使用欧冠 Java 8: ");
        System.out.println("列表：" + strings);
        ...
        System.out.println("字符串的长度为 3 的数量为 ：" +count);
        
        filterd = strings.stream().filter(string -> !string.isEmpty()).collect(Collectors.toList());
        System.out.println("筛选后的列表：" + filterd);
        ...
        System.out.println("列表中最大的数：" + stats.getCount() );
    ...
    private static List<Integer> getSqures(List<Integer> numbers) {
