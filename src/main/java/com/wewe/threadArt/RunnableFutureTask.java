...
public class RunnableFutureTask {
    ...
    static void futureDemo() {
        try {
            ...
            //返回默认 result
            Integer result3 = 10;
            FutureTask<Integer> futureTask3 = new FutureTask<>(new Runnable(){
                @Override
                public void run() {
                    fibc(20);
            ...
            // 提交futureTask
            mExecutor.submit(futureTask3) ;
            System.out.println("future result from runnable futureTask  : "
                    + futureTask3.get());
