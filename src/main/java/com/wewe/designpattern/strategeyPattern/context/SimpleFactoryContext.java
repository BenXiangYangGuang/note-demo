...
public class SimpleFactoryContext {
  ...
  static {
    Reflections reflections = new Reflections("com.wewe.designpattern.strategeyPattern.annotation");
    Set<Class<?>> annotatedClasses =
        reflections.getTypesAnnotatedWith(com.wewe.designpattern.strategeyPattern.annotation.Strategy.class);
    allStrategies = new ConcurrentHashMap<String, Class>();
    for (Class<?> classObject : annotatedClasses) {
      com.wewe.designpattern.strategeyPattern.annotation.Strategy strategy = (com.wewe.designpattern.strategeyPattern.annotation.Strategy) classObject
          .getAnnotation(com.wewe.designpattern.strategeyPattern.annotation.Strategy.class);
